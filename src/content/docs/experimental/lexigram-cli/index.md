---
title: CLI (lexigram-cli)
description: Detailed documentation for lexigram-cli, including architecture, usage guides, and configuration options within the Lexigram ecosystem.
---
