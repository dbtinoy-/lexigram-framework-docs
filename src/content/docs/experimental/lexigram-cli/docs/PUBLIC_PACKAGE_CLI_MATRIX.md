---
title: Public Package CLI Surface Matrix
description: Public Package CLI Surface Matrix guide and reference for the lexigram-cli package in the Lexigram framework.
---
