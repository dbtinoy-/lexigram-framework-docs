...
hero:
  tagline: The Python framework that gives your AI a pattern to follow
  actions:
    - text: Get Started
...
<CardGrid>
  ...
  <Card title="Skills" icon="puzzle">
    Teach your agent anything with a markdown file — lexigram-skills bundles into Claude Code, OpenCode, Cursor, or any markdown-aware agent. No plugin SDK, no config.
  </Card>
</CardGrid>
