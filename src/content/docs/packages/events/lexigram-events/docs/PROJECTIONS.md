---
title: 'In ProjectionProtocol.apply():'
description: 'In ProjectionProtocol.apply(): guide and reference for the lexigram-events package in the Lexigram framework.'
---
