---
title: All operations work identically — no external dependencies
description: All operations work identically — no external dependencies guide and reference for the lexigram-notification package in the Lexigram framework.
---
