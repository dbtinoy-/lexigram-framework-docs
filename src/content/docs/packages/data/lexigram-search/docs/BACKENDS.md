---
title: Primary backend resolves as SearchEngine; named ones by Annotated
description: Primary backend resolves as SearchEngine; named ones by Annotated guide and reference for the lexigram-search package in the Lexigram framework.
---
