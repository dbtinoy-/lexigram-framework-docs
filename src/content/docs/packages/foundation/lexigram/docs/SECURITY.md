---
title: Security
description: Security for lexigram
---
...
Found a security vulnerability? Open an issue on [GitHub](https://github.com/lexigram-dev/lexigram/issues) with the label `security`.