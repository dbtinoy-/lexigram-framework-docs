---
title: Vector Stores in lexigram-vector
description: Vector Stores in lexigram-vector guide and reference for the lexigram-vector package in the Lexigram framework.
---
