---
title: Archive the schema (rename to tenant_{id}_deprovisioned)
description: Archive the schema (rename to tenant_{id}_deprovisioned) guide and reference for the lexigram-tenancy package in the Lexigram framework.
---
