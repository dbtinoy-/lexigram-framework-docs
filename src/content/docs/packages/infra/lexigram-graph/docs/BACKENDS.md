---
title: GraphStoreProtocol resolves to InMemoryGraphStore
description: GraphStoreProtocol resolves to InMemoryGraphStore guide and reference for the lexigram-graph package in the Lexigram framework.
---
