                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                { label: 'lexigram-ai', slug: 'platform/lexigram-ai' },
                                { label: 'lexigram-ai-agents', slug: 'platform/lexigram-ai-agents' },
                                { label: 'lexigram-ai-evaluation', slug: 'platform/lexigram-ai-evaluation' },
                                { label: 'lexigram-ai-feedback', slug: 'platform/lexigram-ai-feedback' },
                                { label: 'lexigram-ai-governance', slug: 'platform/lexigram-ai-governance' },
                                { label: 'lexigram-ai-guard', slug: 'platform/lexigram-ai-guard' },
                                { label: 'lexigram-ai-llm', slug: 'platform/lexigram-ai-llm' },
                                { label: 'lexigram-ai-mcp', slug: 'platform/lexigram-ai-mcp' },
                                { label: 'lexigram-ai-memory', slug: 'platform/lexigram-ai-memory' },
                                { label: 'lexigram-ai-observability', slug: 'platform/lexigram-ai-observability' },
                                { label: 'lexigram-ai-prompt', slug: 'platform/lexigram-ai-prompt' },
                                { label: 'lexigram-ai-rag', slug: 'platform/lexigram-ai-rag' },
                                { label: 'lexigram-ai-session', slug: 'platform/lexigram-ai-session' },
                                { label: 'lexigram-ai-skills', slug: 'platform/lexigram-ai-skills' },
                                { label: 'lexigram-ai-workers', slug: 'platform/lexigram-ai-workers' },
                            ],
                        },
                        {
                            label: 'lexigram-multimedia',
                            items: [
                                { label: 'lexigram-multimedia', slug: 'platform/lexigram-multimedia' },
                                { label: 'lexigram-multimedia-beat', slug: 'platform/lexigram-multimedia-beat' },
                                { label: 'lexigram-multimedia-image', slug: 'platform/lexigram-multimedia-image' },
                                { label: 'lexigram-multimedia-interpolate', slug: 'platform/lexigram-multimedia-interpolate' },
                                { label: 'lexigram-multimedia-music', slug: 'platform/lexigram-multimedia-music' },
                                { label: 'lexigram-multimedia-tts', slug: 'platform/lexigram-multimedia-tts' },
                                { label: 'lexigram-multimedia-upscale', slug: 'platform/lexigram-multimedia-upscale' },
                                { label: 'lexigram-multimedia-video', slug: 'platform/lexigram-multimedia-video' },
                            ],
                        },
                    ],
                },
