                    ...
                    items: [
                        {
                            label: 'lexigram-ai',
                            items: [
                                { label: 'AI Platform Overview', slug: 'platform' },
                                { label: 'lexigram-ai', autogenerate: { directory: 'platform/lexigram-ai' } },
                                { label: 'lexigram-ai-agents', autogenerate: { directory: 'platform/lexigram-ai-agents' } },
                                { label: 'lexigram-ai-evaluation', autogenerate: { directory: 'platform/lexigram-ai-evaluation' } },
                                { label: 'lexigram-ai-feedback', autogenerate: { directory: 'platform/lexigram-ai-feedback' } },
                                { label: 'lexigram-ai-governance', autogenerate: { directory: 'platform/lexigram-ai-governance' } },
                                { label: 'lexigram-ai-guard', autogenerate: { directory: 'platform/lexigram-ai-guard' } },
                                { label: 'lexigram-ai-llm', autogenerate: { directory: 'platform/lexigram-ai-llm' } },
                                { label: 'lexigram-ai-mcp', autogenerate: { directory: 'platform/lexigram-ai-mcp' } },
                                { label: 'lexigram-ai-memory', autogenerate: { directory: 'platform/lexigram-ai-memory' } },
                                { label: 'lexigram-ai-observability', autogenerate: { directory: 'platform/lexigram-ai-observability' } },
                                { label: 'lexigram-ai-prompt', autogenerate: { directory: 'platform/lexigram-ai-prompt' } },
                                { label: 'lexigram-ai-rag', autogenerate: { directory: 'platform/lexigram-ai-rag' } },
                                { label: 'lexigram-ai-session', autogenerate: { directory: 'platform/lexigram-ai-session' } },
                                { label: 'lexigram-ai-skills', autogenerate: { directory: 'platform/lexigram-ai-skills' } },
                                { label: 'lexigram-ai-workers', autogenerate: { directory: 'platform/lexigram-ai-workers' } },
                            ],
                        },
                        {
                            label: 'lexigram-multimedia',
                            items: [
                                { label: 'lexigram-multimedia', autogenerate: { directory: 'platform/lexigram-multimedia' } },
                                { label: 'lexigram-multimedia-beat', autogenerate: { directory: 'platform/lexigram-multimedia-beat' } },
                                { label: 'lexigram-multimedia-image', autogenerate: { directory: 'platform/lexigram-multimedia-image' } },
                                { label: 'lexigram-multimedia-interpolate', autogenerate: { directory: 'platform/lexigram-multimedia-interpolate' } },
                                { label: 'lexigram-multimedia-music', autogenerate: { directory: 'platform/lexigram-multimedia-music' } },
                                { label: 'lexigram-multimedia-tts', autogenerate: { directory: 'platform/lexigram-multimedia-tts' } },
                                { label: 'lexigram-multimedia-upscale', autogenerate: { directory: 'platform/lexigram-multimedia-upscale' } },
                                { label: 'lexigram-multimedia-video', autogenerate: { directory: 'platform/lexigram-multimedia-video' } },
                            ],
                        },
                    ],
                },
